...
For more information about Spectre and Meltdown on Windows Operating Systems, read the [support article](https://support.microsoft.com/en-us/help/4072698/windows-server-speculative-execution-side-channel-vulnerabilities-prot) on the Microsoft website. This article describes how to enable or disable the mitigations in Windows.

To address the risk from L1TF you are required to take an extra step. In VMware vSphere the so called [Side-Channel-Aware scheduler](https://kb.vmware.com/s/article/55806) is available. On Hyper-V there is a similar feature called the [Hyper-V Core Scheduler](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/adv180018). Performance-wise, enabling these schedulers can have the same impact as disabling Hyperthreading.
...
Photo by [Shawn Ang](https://unsplash.com/photos/0VSZVXggySQ?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/search/photos/melt-ice?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)